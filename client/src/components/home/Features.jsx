    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <div className="flex flex-col items-center w-full max-w-7xl mt-10">
                ...
                <img className="max-w-2xl w-full mb-12" src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/features/group-image-1.png" alt="" />
                ...
                >
                    ...
                    {/* Feature 2 */}
                    <div className="flex items-center justify-center group cursor-pointer">
                        <div className="p-6 w-full h-full group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            <div className="shrink-0">
                    ...
                    <div className="flex items-center justify-center group cursor-pointer">
                        <div className="p-6 w-full h-full group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600">Export professional, audit-ready financial reports.</p>
                            </div>
                        </div>
                    </div>
